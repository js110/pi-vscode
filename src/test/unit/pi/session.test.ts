...
const liveIt = process.env.PI_VSCODE_LIVE_TESTS === '1' ? it : it.skip;
...
describe('Pi AgentSession', () => {
    ...
    liveIt('can send a prompt and receive streaming events', async () => {
    ...
    liveIt('messages are persisted after prompt', () => {
