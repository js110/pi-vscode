...
const EN = {
    ...
    'plan.awaiting': 'Plan ready — review, edit, then approve',
    'plan.executing': 'Executing plan',
    'plan.paused': 'Plan paused',
    'plan.done': 'Plan complete',
    'plan.interrupted': 'Interrupted — {done}/{total} steps completed',
    'plan.approve': 'Approve & execute',
    'plan.replan': 'Re-plan',
    'plan.cancel': 'Cancel planning',
    'plan.resume': 'Resume',
    'plan.adjust': 'Adjust & re-approve',
    'plan.abandon': 'Abandon',
    'plan.close': 'Close',
    'plan.noPlan': 'The model did not return a plan. Send your request again.',
    'plan.pausedDangerous': 'A potentially dangerous tool needs approval.',
    'plan.pausedStep': 'Step failed: {reason}',
    'plan.escHint': 'Interrupting keeps completed steps.',
    'plan.stepUp': 'Move up',
...
const ZH: Record<TextKey, string> = {
    ...
    'plan.awaiting': '计划就绪 — 请审阅、调整后批准',
    'plan.executing': '正在执行计划',
    'plan.paused': '计划已暂停',
    'plan.done': '计划完成',
    'plan.interrupted': '已中断 — 已完成 {done}/{total} 步',
    'plan.approve': '批准执行',
    'plan.replan': '重新规划',
    'plan.cancel': '取消规划',
    'plan.resume': '续跑',
    ...
    'plan.abandon': '放弃',
    'plan.close': '关闭',
    'plan.noPlan': '模型未返回计划，请重新发送。',
    'plan.pausedDangerous': '有潜在危险工具等待批准。',
    'plan.pausedStep': '步骤失败：{reason}',
    'plan.escHint': '中断将保留已完成步骤。',
    'plan.stepUp': '上移',
    'plan.stepDown': '下移',
