...
const EN = {
    ...
    'settings.fontSizeDesc': 'Base font size in px. Labels, metadata and code blocks scale with it. Reload the panel to apply.',
...
// 宿主命令提示（T17 残留文案收口）
    ...
    'settings.fontSizeDesc': '基础字号（px）。标签、元信息和代码块随之缩放。重新加载面板后生效。',
